...
public class WebCategoryFiltrationsTest {
    ...
    public void Build() throws InterruptedException {
        ...
        log.info("Starting test for wish log info...");
        LogsUtils.info("open Air-Conditioner logs utils...");
        BasePage.openUrl("https://www.raneen.com/");
        log.info("Starting test for wish log info...");
        LogsUtils.info("open Air-Conditioner logs utils...");
        Utility.clickingOnElement(driver, By.xpath("/html/bodnjknjy/div[3]/header/div[2]/div[1]/div/form/div[2]/input")); //click on wish list icon
